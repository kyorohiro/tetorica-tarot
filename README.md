...
% sh deploy_mac.sh
% ~/bin/butler login
% ~/bin/butler push src-tauri/target/release/bundle/dmg/tetorica-tarot_0.4.5_aarch64.dmg kyorohiro/tetorica-tarot:mac-apple-silicon --userversion 0.4.5

% ~/bin/butler push src-tauri/target/x86_64-apple-darwin/release/bundle/dmg/tetorica-tarot_0.4.5_x64.dmg kyorohiro/tetorica-tarot:mac-intel --userversion 0.4.5

% ~/bin/butler push "tetorica-tarot_0.4.5_x64-setup.exe" kyorohiro/tetorica-tarot:windows --userversion 0.4.5
```
